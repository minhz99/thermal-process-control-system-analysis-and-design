...
# ============================================================
# MO PHONG DAP UNG XUNG (Impulse Response)
# Dap ung xung = dao ham dap ung bac thang
# Hoac dung sig.impulse tren ham truyen vong kin
# ============================================================
...
# Ve dap ung xung voi vung doi dau
...
# ---- Subplot 1: Vong trong ----
plot_impulse(ax1, t_inner, y2_impulse, '#1976D2',
             r'Dap ung xung $y_2(t)$ (luu luong dau)')
ax1.set_title('Dap ung xung vong dieu khien luu luong dau (Vong trong)',
...
# ---- Subplot 2: Vong ngoai ----
plot_impulse(ax2, t_outer, y1_impulse, '#D32F2F',
             r'Dap ung xung $y_1(t)$ (ap suat hoi)')

# Ve them dap ung xung vong trong de so sanh (cung he truc thoi gian)
ax2_t = t_inner
ax2.plot(ax2_t, y2_impulse, color='#1976D2', linewidth=1.5, linestyle='-.',
         alpha=0.7, label=r'Dap ung xung vong trong (tham chieu)')

ax2.set_title('Dap ung xung vong dieu khien ap suat hoi (Hai vong von kin)',
              fontsize=13, fontweight='bold', pad=10)
...
out_path = ("/Users/minhz/Desktop/HUST/KS/Phan tich va tong hop he thong dieu khien "
            "qua trinh nhiet/btl-dk/Hinhve/impulse_response.png")
