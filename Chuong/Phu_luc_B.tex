...
Kết quả mô phỏng từ chương trình trên được sử dụng trong Hình~\ref{fig:step_response}.
...
Tương tự, chương trình đáp ứng xung mô phỏng phản ứng của hệ thống khi có nhiễu xung tác động vào đầu vào, cho phép đánh giá khả năng kháng nhiễu. Kết quả được sử dụng trong Hình~\ref{fig:impulse_response}.

\lstinputlisting[language=Python, firstline=1, lastline=137,
  caption={Chương trình mô phỏng đáp ứng xung hệ hai vòng},
