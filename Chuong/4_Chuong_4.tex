...
Áp dụng phương pháp nghịch đảo mô hình bền vững kết hợp IMC và Bền vững tối ưu, hai bộ điều khiển được tổng hợp với các thông số:

\begin{table}[htbp]
\centering
\caption{Thông số bộ điều khiển hai vòng}
\label{tab:controller_params}
\begin{tabular}{|l|c|c|c|c|}
\hline
\textbf{Vòng} & \textbf{Bộ ĐK} & \textbf{Phương pháp} & $K_p$ & $T_i$ (s) \\
\hline
Vòng trong & PI & IMC & $4{,}978$ & $4{,}8694$ \\
\hline
Vòng ngoài & PID & Bền vững tối ưu & $1{,}8222$ & $12{,}0712$ \\
\hline
\end{tabular}
\end{table}

Kết quả kiểm chứng mô phỏng trên MATLAB/Simulink cho thấy hệ thống hoạt động ổn định và đáp ứng toàn bộ chỉ tiêu:
...
Về hiệu quả thực tiễn, giải pháp mang lại lợi ích kinh tế (giảm tiêu thụ dầu nhiên liệu, tiết kiệm chi phí vận hành), xã hội và môi trường (giảm phát thải khí độc CO, NO$_x$, SO$_x$) đồng thời nâng cao độ an toàn nhờ các cơ chế bảo vệ liên động (MFT) được tích hợp trong hệ thống.
