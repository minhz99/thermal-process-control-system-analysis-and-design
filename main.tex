...
\usepackage{pifont} % Cho ký hiệu \ding trong danh sách
\usepackage{tikz} % Thư viện vẽ hình
\usetikzlibrary{calc, arrows.meta, positioning, patterns, shapes.geometric} % Add calc, arrows.meta, positioning, patterns, shapes.geometric libraries for TikZ coordinates and styles
...
\usepackage{relsize} % Hỗ trợ \mathsmaller cho subscript trong math mode
...
\usepackage{tcolorbox} % Gói tạo hộp màu
\tcbuselibrary{skins} % Thư viện hỗ trợ tcolorbox
\usepackage{pgfplots} % Vẽ đồ thị trong TikZ
...
\graphicspath{{figures/}{../figures/}{tikz/}} % Thư mục chứa các hình ảnh và TikZ
